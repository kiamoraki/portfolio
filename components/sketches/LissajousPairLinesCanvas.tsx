...
// Greedy "best-matching first" solution to the assignment problem:
// at each step we pick the unassigned (source, target) pair with the
// smallest squared distance and lock them together. Not provably optimal
// like Hungarian, but for 20 particles it produces visibly near-optimal
// assignments — and runs in trivial O(n³) (≈8000 ops, once per rollover).
