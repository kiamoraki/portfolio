...
const SLIDES: Slide[] = [
  {
    srcs: [
      { src: "/img/22-fake_rekordz/220817-spanky.jpg", alt: "Spanky" },
      { src: "/img/22-fake_rekordz/220901-claireshort.jpg", alt: "Claire Short" },
    ],
  },
  {
    srcs: [
      { src: "/img/22-fake_rekordz/220925-popelaz.jpg", alt: "Popelaz" },
      { src: "/img/22-fake_rekordz/221017-lynxyx.jpg", alt: "Lynxyx" },
    ],
  },
  {
    srcs: [
      { src: "/img/22-fake_rekordz/221025-claireshort.jpg", alt: "Claire Short" },
      { src: "/img/22-fake_rekordz/221025-casualt.jpg", alt: "Casual T" },
    ],
  },
  {
    srcs: [
      { src: "/img/22-fake_rekordz/230316-spaceout.jpg", alt: "Spaceout" },
      { src: "/img/22-fake_rekordz/240319-bbbiennale.jpg", alt: "BB Biennale" },
    ],
  },
  {
    srcs: [
      { src: "/img/22-fake_rekordz/230519-goldify.jpg", alt: "Goldify" },
    ],
  },
];
...
export function FakeRekordzCarousel() {
